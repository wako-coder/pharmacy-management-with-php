                    ...
                    <div class="col-5">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="pharmacy_stock.php">Home</a></li>
                                    <li class="breadcrumb-item "><a href="manage_pharmacy.php">Top Up Phamacy</a></li>
					...
					<div class="col-md-12">
						...
						<div class="row mb-3">
								...
								<div class="col-md-6">
									...
									<input type="text" name="medicine_name" value="<?php echo $medicine_name;?> || Expiry Date <?php echo "$expiry_date";?> || Available qty= <?php echo "$capacity";?>"  class="form-control text-right" step="any"  >
								</div>
								<?php
										}
							...
							?>
								<div class="col-md-2 form-group">
									...
									<input type="hidden" name="Sqty" value="<?php echo $capacity;?>" class="form-control text-right prc" id="qty" step="any" >
