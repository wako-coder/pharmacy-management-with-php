      ...
      <?php require_once"includes/asidem.php";?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <?php
require "includes/conn.php";
$queryfetch=mysqli_query($conn,"SELECT * FROM pharmacist WHERE pharmacist_id='".$userid."'") or die(mysqli_error());
...
$sql=mysqli_query($conn, "UPDATE pharmacist SET first_name='$fname', last_name='$lname', staff_id='$sid',postal_address='$postal',phone='$phone',email='$email',username='$username', password='$pas' WHERE Doctor_id='".$userid."'");
