    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            ...
                            if($count > 0){
                                ...
                                while ($rows=mysqli_fetch_assoc($res)) {
                                    ...
                                    $qty=$rows['qty'];
                                    ?>
                                <form action="cashiersold.php" method="post" id="manage-sales">
							...
							?>
								...
								if ($res == TRUE) {
									...
									if($count > 0){
									   ...
									   ?> <div id="printableArea" style="visibility: hidden; height: 3px; wiedth: 4px" class="hidden ">
                                                                       
                                       <h1> Thanks for your purchase!</h1>
                                        <p class="h3">   Patient ID:: <?php echo $id;?> <hr>
                                        <p class="h3">  Patient Name:: <?php echo $patient_name;?></p>
                                        <p class="h3">  Medicine Name:: <?php echo $medicine_name;?></p>
                                        <p class="h3">  Total Price:: <?php echo $price * $qty;?></p>
             ...
             <button class="btn btn-block btn-block btn-success" name="submit"
                                                        type="submit"><i class="fa fa-plus"></i>Finish</button>
                                                    <input  class="btn btn-block btn-block btn-info" type="button" onclick="printDiv('printableArea')"
                                                        value="print" />
