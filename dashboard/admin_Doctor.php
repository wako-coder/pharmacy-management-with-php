...
$user=$_POST['username'];
$pas=$_POST['password'];
$sql1=mysqli_query($conn,"SELECT * FROM doctor WHERE username='$user'")or die(mysqli_error());
...
$sql=mysqli_query($conn,"INSERT INTO Doctor(first_name,last_name,staff_id,postal_address,phone,email,username,password,date)
VALUES('$fname','$lname','$sid','$postal','$phone','$email','$user','$pas',NOW())");
if($sql>0) {
echo '<script type="text/javascript">'; 
echo 'alert("Doctor successifully added.");'; 
echo 'window.location.href = "admin_Doctor.php";';
echo '</script>';
}else{
...
<!-- <hr/>	 -->
       ...
       $result = mysqli_query($conn, "SELECT * FROM doctor")or die(mysql_error());
		// display data in table
        echo "<table border='2' cellpadding='24'align='center'>";
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				?>
				<td><a href="update_Doctor.php?id=<?php echo $row['Doctor_id']?>"><img src="img/update-icon.png" width="35" height="35" border="0" /></a></td>
				<td><a href="delete_Doctor.php?id=<?php echo $row['Doctor_id']?>"><img src="img/delete-icon.jpg" width="35" height="35" border="0" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
?> 
			...
			//   echo $message1;
			  ?>
			<fieldset class="bg-warning"><legend class="bg-warning" >To add new Doctor,Please fill the informaton nedded down below.</legend>
		<form name="form1" onsubmit="return validateForm(this);" action="admin_Doctor.php" method="post" class="insert" >
