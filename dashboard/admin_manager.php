...
echo 'window.location.href = "admin_manager.php";';
echo '</script>';
}else{
...
<!-- <hr/>	 -->
       ...
       $result = mysqli_query($conn, "SELECT * FROM manager")or die(mysql_error());
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				?>
				<td><a href="update_manager.php?id=<?php echo $row['manager_id']?>"><img src="img/update-icon.png" width="35" height="35" border="0" /></a></td>
				<td><a href="delete_manager.php?id=<?php echo $row['manager_id']?>"><img src="img/delete-icon.jpg" width="35" height="35" border="0" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
?> 
        ...
        <div id="content_2"  class="bg-warning">  
			...
			//   echo $message1;
			  ?>
			<fieldset class="bg-warning"><legend class="bg-warning" >To add new Manager,Please fill the informaton nedded down below.</legend>
