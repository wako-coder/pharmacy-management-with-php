...
<!-- <hr/>	 -->
       ...
       $result = mysqli_query($conn, "SELECT * FROM pharmacist")or die(mysql_error());
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				?>
				<td><a href="update_pharmacist.php?id=<?php echo $row['pharmacist_id']?>"><img src="img/update-icon.png" width="35" height="35" border="0" /></a></td>
				<td><a href="delete_pharmacist.php?id=<?php echo $row['pharmacist_id']?>"><img src="img/delete-icon.jpg" width="35" height="35" border="0" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
?> 
			...
			//   echo $message1;
			  ?>
			<fieldset class="bg-warning"><legend class="bg-warning" >To add new Pharmacist,Please fill the informaton nedded down below.</legend>
