       ...
       <?php require "includes/asides.php";?>
        ...
        <div class="page-wrapper">
            ...
            ?>
									...
									action="includes/update_items_stock_inc.php" method="post">
                                   <?php 
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                <label for="example-email" class="col-md-4">Qty</label>
                                                <input type="text" name="capacity"  class="form-control form-control-line"  >
                                                <input type="hidden" name="existing_capacity" value="<?php echo $capacity?>"
