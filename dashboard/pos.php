						 ...
						 <div class="card-body">
							...
							?>
                                        ...
                                        <div class="col-md-2"><br>
                                            ...
                                            <div class="form-group col-md-3">
										<label class="control-label">medicine_name</label>
										<input readonly type="text" name="medicine_name" value="<?php echo $medicine_name;?>" class="form-control text-right" step="any" id="qty" >
									</div>	

                                    <!-- <div class="form-group col-md-3">
										<label class="control-label">id</label> -->
										<input readonly type="hidden" name="id" value="<?php echo $id;?>" class="form-control text-right" step="any" id="qty" >
									<!-- </div>	 -->

                                            <div class="form-group col-md-3">
										<label class="control-label">Price</label>
										<input readonly type="text" name="price" value="<?php echo $price;?>" class="form-control text-right" step="any" id="qty" >
									</div>		
                                    
                                    <div class="form-group col-md-3">
										<label class="control-label">Available QTY</label>
										<input readonly type="text" name="pharmacy_Qty" value="<?php echo $pharmacy_Qty;?>" class="form-control text-right" step="any" id="qty" >
									</div>	
