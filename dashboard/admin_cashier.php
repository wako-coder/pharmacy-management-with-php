...
echo 'alert("cashier successifully added.");'; 
echo 'window.location.href = "admin_cashier.php";';
echo '</script>';
}else{
...
<!-- <hr/>	 -->
       ...
       $result = mysqli_query($conn, "SELECT * FROM cashier")or die(mysql_error());
		// display data in table
        echo "<table border='2' cellpadding='25'align='center'>";
        ...
        while($row = mysqli_fetch_array( $result )) {
				...
				?>
				<td><a href="update_cashier.php?id=<?php echo $row['cashier_id']?>"><img src="img/update-icon.png" width="35" height="35" border="0" /></a></td>
				<td><a href="delete_cashier.php?id=<?php echo $row['cashier_id']?>"><img src="img/delete-icon.jpg" width="35" height="35" border="0" /></a></td>
				<?php
		 } 
        // close table>
        echo "</table>";
?> 
			...
			//   echo $message1;
			  ?>
			<fieldset class="bg-warning"><legend class="bg-warning" >To add new Cashier,Please fill the informaton nedded down below.</legend>
